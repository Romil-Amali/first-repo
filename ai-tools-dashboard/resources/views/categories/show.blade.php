...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="bg-gradient-to-r from-blue-600 to-purple-600 rounded-lg shadow-xl p-8 mb-8 text-white">
        ...
        <div class="mt-4">
            <span class="inline-flex items-center px-4 py-2 rounded-full text-sm font-semibold bg-white text-blue-800">
                {{ $tools->total() }} tools tersedia
            </span>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
        ...
        <div class="col-span-3 text-center py-12">
            <p class="text-gray-600 text-lg">Belum ada tools dalam kategori ini.</p>
        </div>
        @endforelse
    </div>
